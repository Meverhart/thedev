...
class MenuitemsControllerTest < ActionController::TestCase
  ...
  test "should create menuitem" do
    assert_difference('Menuitem.count') do
      post :create, menuitem: { description: @menuitem.description, image_url: @menuitem.image_url, item: @menuitem.item, price: @menuitem.price, section: @menuitem.section }
    end
  ...
  test "should update menuitem" do
    patch :update, id: @menuitem, menuitem: { description: @menuitem.description, image_url: @menuitem.image_url, item: @menuitem.item, price: @menuitem.price, section: @menuitem.section }
    assert_redirected_to menuitem_path(assigns(:menuitem))
  end
